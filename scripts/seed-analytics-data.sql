...
-- Run this in your PostgreSQL database to see sample data in the User Activity dashboard
...
-- Insert test interactions (scroll events)
...
UNION ALL
SELECT 'Exit Points', COUNT(*) FROM "exit_points"
UNION ALL
SELECT 'Conversions', COUNT(*) FROM "conversion_events";
