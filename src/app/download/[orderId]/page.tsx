      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          ...
          <div className="text-center py-8">
            <ArrowDownTrayIcon className="h-16 w-16 text-purple-600 mx-auto mb-4" />
            ...
            <button
              ...
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold text-lg rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl p-6 text-center shadow-md">
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Secure Download</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-white rounded-xl p-6 text-center shadow-md">
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Access Anytime</h4>
            <p className="text-sm text-gray-600">
