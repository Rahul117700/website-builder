...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(
        `/auth/signin?signup=success&callbackUrl=${encodeURIComponent(callbackUrl)}`,
      );
    } catch (err) {
  ...
  const passwordStrength = () => {
    ...
    if (password.length < 6)
      return { score: 1, text: "Too weak", color: "text-red-500" };
    if (password.length < 8)
      return { score: 2, text: "Weak", color: "text-orange-500" };
    if (password.length < 10)
      return { score: 3, text: "Fair", color: "text-yellow-500" };
    if (password.length < 12)
      return { score: 4, text: "Good", color: "text-blue-500" };
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 lg:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row bg-[#111111]/80 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl border border-white/5 relative overflow-hidden my-auto">
          ...
          <div className="relative z-10 flex flex-col h-full gap-8">
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              <p className="text-lg text-gray-400 mb-8 leading-relaxed max-w-lg">
                Build your custom platform, monetize your audience, and keep
                100% of your earnings. No coding required.
              </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      You keep what you earn, forever.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-auto">
                <div className="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/5 flex flex-col items-center justify-center text-center">
        ...
        <div className="w-full lg:w-[480px] p-8 lg:p-12 relative z-10 flex flex-col justify-center bg-[#0a0a0a]/50">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0d0d0d] text-gray-400">
          ...
          <form className="space-y-5" onSubmit={handleSubmit} method="POST">
              ...
              {password.length > 0 && (
                <div className="mt-3">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span
                      className={`text-[11px] font-bold uppercase tracking-wider w-16 text-right ${strength.color}`}
                    >
                      {strength.text}
                    </span>
                  </div>
            ...
            {error && (
              <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-xl">
                <p className="text-sm text-red-500/90 font-medium text-center">
                  {error}
                </p>
              </div>
            )}
