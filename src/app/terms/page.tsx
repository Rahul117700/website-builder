            ...
            <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl p-8 border border-gray-200">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Website Builder shall not be liable for any indirect, incidental, special, consequential, or punitive damages, 
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    Website Builder operates, without regard to its conflict of law provisions.
                  </p>
                </div>
              </div>
            </div>
