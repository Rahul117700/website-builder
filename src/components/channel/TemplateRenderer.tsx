    ...
    return (
      ...
      >
                ...
                <div className="relative">
                  ...
                  {showNavDropdown && (
                    <>
                      ...
                      />
                      <div 
                        className="absolute left-0 mt-2 w-64 max-h-[80vh] overflow-y-auto rounded-xl shadow-2xl border z-50 animate-fade-in scrollbar-hide"
                        style={{
                          backgroundColor: backgroundColor,
                          borderColor: `${textColor}15`,
                          ...
                          <nav className="space-y-1 mb-2">
                            ...
                            {session?.user && (
                              <button
                                ...
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
                                  activeSidebarItem === 'subscriptions'
                                    ? 'bg-gray-100 font-semibold'
                                    : 'hover:bg-gray-50'
                                }`}
                                style={{
                                  ...
                                  <div className="mt-2 space-y-1 max-h-48 overflow-y-auto">
                                    {playlists.map((playlist) => (
                                      <button
                                        ...
                                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
                                          activeSidebarItem === `playlist-${playlist.id}`
                                            ? 'bg-gray-100 font-semibold'
                                            : 'hover:bg-gray-50'
                                        }`}
                                        style={{
                  ...
                  <div className="relative">
                    ...
                    {showUserMenu && (
                      <>
                        ...
                        />
                        <div 
                          className="absolute right-0 mt-3 w-80 max-h-[90vh] overflow-y-auto rounded-xl shadow-2xl border z-50 animate-fade-in scrollbar-hide"
                          style={{
                            backgroundColor: backgroundColor,
                            borderColor: `${textColor}15`,
                            boxShadow: `0 20px 60px ${textColor}20`,
        ...
        <div className="flex relative">
          ...
          <aside 
            className={`hidden lg:block fixed lg:sticky top-16 lg:top-20 left-0 h-[calc(100vh-4rem)] lg:h-[calc(100vh-5rem)] z-40 border-r border-gray-200 transition-all duration-300 overflow-y-auto scrollbar-hide w-64`}
            style={{ 
              scrollbarWidth: 'none', 
                ...
                <>
                  ...
                  <nav className="space-y-1">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-4 px-4 py-3 rounded-lg transition-all duration-200 hover:bg-gray-50 border border-dashed border-gray-300"
                      style={{
                        color: `${textColor}CC`,
                      }}
                    >
                    ...
                    {!isOwner && channel.subscriptionEnabled && getSubscribeButtonText() && (
                      !session?.user ? (
                        ...
                        <button 
                          onClick={() => setShowSubscriptionModal(true)}
                          disabled={hasActiveSubscription}
                          className={`w-full px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl font-bold text-base sm:text-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed ${
                            hasActiveSubscription 
            ...
            <div className="relative bg-white border-b border-gray-200 shadow-sm py-3 sm:py-4 px-3 sm:px-4 md:px-6 lg:px-12">
              ...
              <div className="relative w-full">
                <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                  <MagnifyingGlassIcon className="h-5 w-5 sm:h-6 sm:w-6 text-gray-500" />
                </div>
                <input
                  type="text"
                  ...
                  className="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-3.5 bg-white border border-gray-300 rounded-full text-sm sm:text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm"
                  style={{ 
                    fontFamily: bodyFont,
                    letterSpacing: '-0.01em',
                  }}
              ...
              {/* Mobile-Optimized Horizontal Filter Bar */}
              <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto pb-2 scrollbar-hide -mx-3 sm:-mx-0 px-3 sm:px-0" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                {categories.map((category) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 sm:px-4 py-2 sm:py-2.5 rounded-full font-medium text-xs sm:text-sm whitespace-nowrap transition-all duration-200 flex-shrink-0 active:scale-95 touch-manipulation ${
                        selectedCategory === category
                          ? 'bg-gray-900 text-white shadow-md active:bg-gray-800'
                    ...
                    >
                      {category} <span className="opacity-70 ml-1">({count})</span>
                    </button>
                  );
                })}
              </div>
              ...
              <div className="flex flex-col gap-2 sm:gap-3 pt-2 sm:pt-3 border-t border-gray-200">
                ...
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                  {/* Filter Button - Larger on mobile */}
                  <button
                    onClick={() => setShowFilters(!showFilters)}
                    className={`px-4 py-2.5 sm:px-4 sm:py-2 rounded-full font-medium text-sm transition-all duration-200 flex items-center gap-2 active:scale-95 touch-manipulation ${
                  ...
                  >
                    <FunnelIcon className="h-4 w-4 sm:h-4 sm:w-4" />
                  ...
                  <div className="relative flex-1 sm:flex-none min-w-[140px] sm:min-w-[160px]">
                    <select
                      ...
                      className="appearance-none w-full px-4 py-2.5 sm:py-2 pr-10 bg-gray-100 border border-gray-200 rounded-full font-medium text-sm text-gray-800 active:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 cursor-pointer touch-manipulation"
                      style={{ minHeight: '44px' }}
                    >
              ...
              {/* Advanced Filters Panel - YouTube Style */}
              {showFilters && (
                ...
                {filteredProducts.map((product: any, index: number) => {
                  ...
                  if (viewMode === 'list') {
                    return (
                      ...
                      >
                        <div className="relative bg-white border border-gray-200 rounded-xl sm:rounded-2xl overflow-hidden shadow-sm hover:shadow-xl sm:hover:shadow-2xl transition-all duration-500">
                          <div className="flex flex-col sm:flex-row gap-0">
                            {/* Thumbnail */}
                            <div className="flex-shrink-0 w-full sm:w-64 h-48 sm:h-auto bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden relative">
                              {(product.type === 'VIDEO' || product.type === 'VIDEOS') && (product.videoUrl || product.fileUrl) ? (
                                <>
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="w-16 h-16 rounded-full flex items-center justify-center bg-white/95 backdrop-blur-sm shadow-xl">
                                  ...
                                  <div className="absolute top-4 right-4">
                                    <div className="px-3 py-1.5 rounded-lg bg-white/95 backdrop-blur-sm shadow-lg border border-white/50">
                                ...
                                >
                                  <div className="text-gray-400" style={{ color: primaryColor }}>
                                    {getContentIcon(product.type)}
                                  </div>
                                  <div className="absolute top-4 right-4">
                                    <div className="px-3 py-1.5 rounded-lg bg-white/95 backdrop-blur-sm shadow-lg border border-white/50">
                                      <span className="text-xs font-bold text-gray-900 uppercase tracking-wide">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                                  {product.tags && product.tags.length > 0 && (
                                    <span className="text-xs font-semibold px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg bg-gray-100 text-gray-700 border border-gray-200">
                                      {product.tags[0]}
                                    </span>
                                  )}
                                </div>
                                <h3 
                                  className="text-lg sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-900 leading-tight group-hover:text-gray-700 transition-colors duration-300"
                                  style={{ 
                                    fontFamily: headingFont,
                                ...
                                {product.description && (
                                  <p 
                                    className="text-xs sm:text-sm text-gray-600 line-clamp-2 sm:line-clamp-3 mb-3 sm:mb-4 leading-relaxed"
                                    style={{ 
                                      fontFamily: bodyFont,
                                      letterSpacing: '-0.01em',
                                      lineHeight: '1.5',
                                  ...
                                  {session?.user && (
                                    <div className="flex items-center gap-2">
                                      ...
                                      <button
                                        ...
                                        title={isProductSaved(product.id) ? 'Remove from saved' : 'Save product'}
                                      >
                                ...
                                <div className="flex justify-end">
                                  {canAccess ? (
                                    <button
                                      ...
                                      className="w-full sm:w-auto px-6 py-2.5 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white rounded-xl font-semibold text-sm hover:shadow-lg active:scale-95 transition-all duration-200 flex items-center justify-center gap-2"
                                    >
                                      View
                                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative bg-white border border-gray-200 rounded-lg sm:rounded-xl overflow-hidden shadow-sm active:shadow-md sm:hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                        ...
                        <div className="relative w-full aspect-video sm:aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
                          {(product.type === 'VIDEO' || product.type === 'VIDEOS') && (product.videoUrl || product.fileUrl) ? (
                            <>
                              <video
                                src={product.videoUrl || product.fileUrl}
                              ...
                              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center bg-white/95 backdrop-blur-sm shadow-2xl transform group-hover:scale-110 transition-all duration-300">
                                  <div className="w-0 h-0 border-l-[12px] sm:border-l-[16px] border-l-gray-900 border-t-[8px] sm:border-t-[10px] border-t-transparent border-b-[8px] sm:border-b-[10px] border-b-transparent ml-1"></div>
                                </div>
                              </div>
                              {/* Type Badge */}
                            ...
                            >
                              ...
                              {/* Type Badge */}
                              <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                                <div className="px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg bg-white/95 backdrop-blur-sm shadow-lg border border-white/50">
                                  <span className="text-xs font-bold text-gray-900 uppercase tracking-wide">
                                    {product.type}
                                  </span>
                                </div>
                        ...
                        <div className="flex-1 flex flex-col p-3 sm:p-4 lg:p-6 min-w-0">
                          {/* Tags */}
                          {product.tags && product.tags.length > 0 && (
                            <div className="mb-2">
                              <span 
                                className="inline-block text-xs font-semibold px-2 py-1 rounded-md bg-gray-100 text-gray-700 border border-gray-200"
                              >
                                {product.tags[0]}
                              </span>
                            </div>
                          ...
                          <h3 
                            className="text-base sm:text-lg lg:text-xl font-semibold sm:font-bold mb-2 text-gray-900 line-clamp-2 leading-tight sm:group-hover:text-gray-700 transition-colors duration-300"
                            style={{ 
                              fontFamily: headingFont,
                              letterSpacing: '-0.02em',
                              fontWeight: 600,
                          ...
                          {product.description && (
                            <p 
                              className="hidden sm:block text-sm text-gray-600 line-clamp-2 mb-3 leading-relaxed"
                              style={{ 
                                fontFamily: bodyFont,
                                letterSpacing: '-0.01em',
                                lineHeight: '1.5',
                          ...
                          <div className="mt-auto pt-3 border-t border-gray-100">
                              ...
                              {session?.user && (
                                <div className="flex items-center gap-2">
                                  <button
                                    ...
                                    className="p-2.5 border border-gray-300 rounded-lg active:bg-gray-100 transition-colors touch-manipulation"
                                    title="Add to Playlist"
                                  ...
                                  <button
                                    onClick={(e) => handleToggleSave(product.id, e)}
                                    className={`p-2.5 border rounded-lg transition-colors active:scale-95 touch-manipulation ${
                                      isProductSaved(product.id)
                            ...
                            {/* View/Subscribe Button - Full width on mobile */}
                            <div className="flex justify-end">
                              {canAccess ? (
                                <button
                                  onClick={(e) => {
                                  ...
                                  className="w-full sm:w-auto px-6 py-3 sm:py-2.5 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white rounded-lg sm:rounded-xl font-semibold text-sm active:scale-95 transition-all duration-200 flex items-center justify-center gap-2 touch-manipulation"
                                  style={{ minHeight: '44px' }}
                                >
                                  View
                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isSectionVisible('footer') && (
          <footer id="about" className="relative border-t border-gray-200 py-16 bg-white scroll-mt-20">
          <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12">
              ...
              <div>
                ...
                {channel.subscriptionEnabled && (
                  <button 
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white rounded-xl font-medium text-sm transition-all shadow-lg hover:shadow-xl hover:scale-105"
                  >
                    Subscribe Now
                  </button>
                )}
                  ...
                  {categories.slice(1, 4).map((category) => (
                    <li key={category}>
                      <button
                        ...
                        className="text-sm text-gray-600 hover:text-gray-900 transition-colors text-left cursor-pointer"
                      >
                        {category}
                      </button>
                    </li>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold" style={{ color: primaryColor }}>
                      {(() => {
                        // Use _count if available, otherwise count from products array
                        if (channel._count?.products !== undefined) {
                          return channel._count.products;
                        }
                        return allProducts?.length || products?.length || 0;
                      })()}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold" style={{ color: secondaryColor }}>
                      {(() => {
                        // Use _count if available, otherwise use subscribers array length
                        if (channel._count?.subscribers !== undefined) {
                          return channel._count.subscribers;
                        }
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold" style={{ color: primaryColor }}>
                      {(() => {
                        // Always calculate total views from all products' viewCount for accuracy
                        const totalViews = allProducts?.reduce((sum: number, p: any) => {
                          return sum + (Number(p.viewCount) || 0);
                        }, 0) || 0;
                        return totalViews;
