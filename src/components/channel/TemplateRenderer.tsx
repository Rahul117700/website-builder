                  ...
                  {(() => {
                    ...
                    return (
                      <div className="w-full">
                        ...
                        <div className="relative group overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 shadow-2xl cursor-pointer" onClick={() => router.push(`/channel/${channel.slug}/products/${featuredProduct.id}`)}>
                          {/* Adaptive Aspect Ratio Container - Better mobile sizing */}
                          <div className="aspect-[9/16] sm:aspect-[4/3] lg:aspect-video relative overflow-hidden">
                            ...
                            <div className="absolute inset-0 p-6 sm:p-8 lg:p-10 z-20 flex flex-col justify-between">
                              ...
                              <div className="space-y-4">
                                {/* Title */}
                                <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black leading-tight tracking-tight text-white drop-shadow-2xl line-clamp-2">
